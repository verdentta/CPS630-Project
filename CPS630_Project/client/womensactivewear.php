...
fetch('http://localhost/CPS630Project/Phase01/server/APIs/getItems.php?' + new URLSearchParams({  gender: '"female"', dept_code: 2}).toString())
.then(res => res.json())
.then(data => {
  data.forEach(item => {
  ...
  function removeItem(e) {
	...
	removeEventListeners(items); // Remove event listeners before adding them again
        ...
        .catch(error => {
		 ...
		 <h1 style="background-color: #f0f7eeff; padding: 5px;">Womens ActiveWear</h1>
		<div class="depts-container">
			<a id="depts" href="#!womenstops">Tops</a><br>
            <a id="depts" href="#!womensbottoms">Bottoms</a><br>
            <a id="depts" href="#!womensactivewear">Activewear</a><br>
            <a id="depts" href="#!womensouterwear">Outerwear</a><br>
		</div>
