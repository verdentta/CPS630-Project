...
fetch('http://localhost/CPS630Project/Phase01/server/APIs/getItems.php?' + new URLSearchParams({  gender: '"male"', dept_code: 2}).toString())
.then(res => res.json())
.then(data => {
  data.forEach(item => {
...
function dragDrop(e) {
  ...
  function removeItem(e) {
	...
	removeEventListeners(items); // Remove event listeners before adding them again
		...
		<h1 style="background-color: #f0f7eeff; padding: 5px;">Mens ActiveWear</h1>
		<div class="depts-container">
			<a id="depts" href="#!menstops">Tops</a><br>
            <a id="depts" href="#!mensbottoms">Bottoms</a><br>
            <a id="depts" href="#!mensactivewear">Activewear</a><br>
            <a id="depts" href="#!mensouterwear">Outerwear</a><br>
		</div>

        <div class="row justify-content-left" id="items_output"></div>
